...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="John"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="18866668888"/>
		<input type="hidden" name="orderShipping.receiverState" value="河南省"/>
		<input type="hidden" name="orderShipping.receiverCity" value="郑州市"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="高新区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="莲花街 xxxxxxxxx"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">John</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">188****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">河南省 郑州市 高新区</div>
						<div class="adr-m" limit="30">莲花街 xxxxxxxx</div>
