...
<%--</div>--%>
<div id="itemParamEditWindow" class="easyui-window" title="编辑规格模板" data-options="modal:true,closed:true,iconCls:'icon-edit',href:'/item-param-edit'" style="width:80%;height:80%;padding:10px;">
</div>
<script>
        ...
        handler:function(){
            ...
            $("#itemParamEditWindow").window({
                onLoad :function(){
                    ...
                    $("#data_span").attr("item-param-data", JSON.stringify(data));
